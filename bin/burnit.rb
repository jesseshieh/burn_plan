...
portfolio = BurnPlan::PortfolioBuilder.new
  ...
  .add_asset(BurnPlan::Asset.new('Small Company Stocks',       1_000))
  .add_asset(BurnPlan::Asset.new('Long-term Corporate Bonds',  1_000))
  .add_asset(BurnPlan::Asset.new('Long Term Government Bonds', 1_000))
  .add_asset(BurnPlan::Asset.new('U.S. Treasury Bills',        1_000))
  .build
